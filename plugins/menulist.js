 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya OHLX BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 OHLX - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 OHLX - BOT..."},
	]
    },{
...
*/
	...
	return conn.sendButton(m.chat, text, wm, img2, [["🥞MENU", _p + "menu"], ["🌸Donasi", _p + "donasi"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: "http://instagram.com/ohlxmarket",
                mediaType: "VIDEO",
                title: '꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦',
                body: 'Source Code By OHLX',
                previewType: 0,
                thumbnail: img
            }
        }
